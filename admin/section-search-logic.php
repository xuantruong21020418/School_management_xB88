...
if (isset($_GET['section-search']) && isset($_GET['submit'])) {
    ...
    if ($search == NULL) {
        ...
        $sql = "SELECT section_id, section FROM sms_section
...
<?php if(isset($_SESSION['edit-section-success'])) : //shows if edit section was successful ?>
    ...
    <main>
        ...
        <div class="utilities-container">
            ...
            <table>
                ...
                WHERE section LIKE '%$search%' LIMIT $offset, $no_of_records_per_page";
            ...
            <?php else : ?>
                <div class="alert__message error lg search"><?= "No section found." ?></div>
            <?php endif ?>
